...
function Github() {
     ...
     const [userDetails , setUserDetails ] = useState({public_repos :'', avatar_url:'', login:'', html_url:'', name:'', bio:''})
  ...
  <>
    ...
    <img src={userDetails.avatar_url} alt={`${userDetails.login} img`} className={`hover:scale-105 transition-all duration-200`} />
